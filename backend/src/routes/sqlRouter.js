...
router.put('/personal_sql/:id', sqlController.updatePersonalData); // Thêm route PUT để cập nhật dữ liệu cá nhân
router.delete('/personal_sql/:id', sqlController.deletePersonalData); // Thêm route DELETE để xóa dữ liệu cá nhân
